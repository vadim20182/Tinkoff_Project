...
class MainChannelsFragment : Fragment(R.layout.fragment_channels_main) {
    ...
    fun addTextListener(fragment: BaseChannelsTabFragment) {
        searchText.addTextChangedListener(fragment.textWatcher)
    }

    fun removeTextListener(fragment: BaseChannelsTabFragment) {
        searchText.removeTextChangedListener(fragment.textWatcher)
    }
}